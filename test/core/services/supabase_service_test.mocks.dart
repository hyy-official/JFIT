...
// in jfit/test/core/services/supabase_service_test.dart.
...
class _FakePostgrestTransformBuilder_17<T1> extends _i1.SmartFake
  ...
  _FakePostgrestTransformBuilder_17(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockPostgrestFilterBuilder<T> extends _i1.Mock
  ...
  _i2.PostgrestTransformBuilder<Map<String, dynamic>> single() =>
      (super.noSuchMethod(
        ...
        returnValue: _FakePostgrestTransformBuilder_17<Map<String, dynamic>>(
          this,
          Invocation.method(
            #single,
            [],
  ...
  _i2.ResponsePostgrestBuilder<_i2.PostgrestResponse<T>, T, T> count(
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _FakeResponsePostgrestBuilder_18<_i2.PostgrestResponse<T>, T, T>(
          this,
          Invocation.method(
            #count,
            [count],
  ...
  _i2.ResponsePostgrestBuilder<Map<String, dynamic>,
      ...
      geojson() => (super.noSuchMethod(
            ...
            returnValue: _FakeResponsePostgrestBuilder_18<Map<String, dynamic>,
                Map<String, dynamic>, Map<String, dynamic>>(
              this,
              Invocation.method(
                #geojson,

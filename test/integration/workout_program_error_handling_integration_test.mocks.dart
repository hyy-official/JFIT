...
// in jfit/test/integration/workout_program_error_handling_integration_test.dart.
...
class _FakeWorkoutProgramModel_0 extends _i1.SmartFake
  ...
  _FakeWorkoutProgramModel_0(Object parent, Invocation parentInvocation)
...
class _FakeExerciseModel_2 extends _i1.SmartFake implements _i4.ExerciseModel {
  _FakeExerciseModel_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockProgramRemoteDataSource extends _i1.Mock
  ...
  _i6.Future<List<_i2.WorkoutProgramModel>> getPopularPrograms() =>
      (super.noSuchMethod(
            Invocation.method(#getPopularPrograms, []),
  ...
  @override
  _i6.Future<void> addProgramToUser(String? programId, String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#addProgramToUser, [programId, userId]),
  ...
  _i6.Future<_i3.Either<_i7.Failure, _i8.DuplicateCheckResult>> saveAsMyRoutine(
    ...
    String? userId,
      ...
      (super.noSuchMethod(
            Invocation.method(#saveAsMyRoutine, [templateProgramId, userId]),
            returnValue:
                _i6.Future<
                  _i3.Either<_i7.Failure, _i8.DuplicateCheckResult>
                >.value(
                  _FakeEither_1<_i7.Failure, _i8.DuplicateCheckResult>(
                    this,
                    Invocation.method(#saveAsMyRoutine, [
                      templateProgramId,
                      userId,
                    ]),
                  ),
  ...
  _i6.Future<List<_i2.WorkoutProgramModel>> searchPrograms(String? query) =>
      (super.noSuchMethod(
            Invocation.method(#searchPrograms, [query]),
            returnValue: _i6.Future<List<_i2.WorkoutProgramModel>>.value(
              <_i2.WorkoutProgramModel>[],
            ),
          )
  ...
  _i6.Future<List<_i10.WorkoutSessionModel>> getWorkoutSessionsByUserProgram(
    String? userProgramId,
      ...
      (super.noSuchMethod(
            Invocation.method(#getWorkoutSessionsByUserProgram, [
              userProgramId,
            ]),
  ...
  _i6.Future<List<_i11.WorkoutLogModel>> getWorkoutLogsBySession(
    String? sessionId,
      ...
      (super.noSuchMethod(
            Invocation.method(#getWorkoutLogsBySession, [sessionId]),
  ...
  _i6.Future<_i4.ExerciseModel> getExerciseById(String? exerciseId) =>
      (super.noSuchMethod(
            ...
            returnValue: _i6.Future<_i4.ExerciseModel>.value(
  ...
  _i6.Future<Map<String, dynamic>?> checkProgramDuplicate(
    ...
    String? userId,
      ...
      (super.noSuchMethod(
            Invocation.method(#checkProgramDuplicate, [programId, userId]),
            returnValue: _i6.Future<Map<String, dynamic>?>.value(),
          )
          as _i6.Future<Map<String, dynamic>?>);

  @override
  _i6.Future<void> restartProgram(String? programId, String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#restartProgram, [programId, userId]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
          )
          as _i6.Future<void>);
  ...
  @override
  _i6.Future<void> continueProgram(String? programId, String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#continueProgram, [programId, userId]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
          )
          as _i6.Future<void>);
  ...
  _i6.Future<void> cleanupDuplicatePrograms(String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#cleanupDuplicatePrograms, [userId]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
          )
          as _i6.Future<void>);

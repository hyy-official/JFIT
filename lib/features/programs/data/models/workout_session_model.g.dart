...
WorkoutSessionModel _$WorkoutSessionModelFromJson(Map<String, dynamic> json) => WorkoutSessionModel(
      ...
      exercisesJson: json['exercises_json'] as Map<String, dynamic>?,
    );

Map<String, dynamic> _$WorkoutSessionModelToJson(WorkoutSessionModel instance) => <String, dynamic>{
      'id': instance.id,

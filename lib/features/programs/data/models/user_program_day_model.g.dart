...
UserProgramDayModel _$UserProgramDayModelFromJson(Map<String, dynamic> json) => UserProgramDayModel(
...
Map<String, dynamic> _$UserProgramDayModelToJson(UserProgramDayModel instance) => <String, dynamic>{
      'id': instance.id,
